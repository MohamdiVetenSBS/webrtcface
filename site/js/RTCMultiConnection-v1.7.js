...
(function () {
    ...
    function setDefaults(connection) {
        ...
        connection.onFileStart = function (file) {
            var bootstrapHTML = '<div class="progress"><div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;"> <span class="sr-only">60% Complete</span> </div> </div>';
            var div = document.createElement('div');
            div.title = file.name;
            div.innerHTML = '<div class="progress"></div> <progress></progress>';
            connection.body.insertBefore(div, connection.body.firstChild);
            progressHelper[file.uuid] = {
                div: div,
                progress: div.querySelector('progress'),
                label: div.querySelector('div.progress')
            };
        ...
        connection.onFileProgress = function (chunk) {
            ...
            helper.progress.style.display ='none';
        ...
        function updateLabel(progress, label) {
            ...
            var bootstrapHTML = '<div class="progress-bar" role="progressbar" aria-valuenow="' + position + '" aria-valuemin="0" aria-valuemax="100" style="width:' + position + '%;"> <span class="sr-only">' + position + '"Complete</span> </div>';
            label.innerHTML = bootstrapHTML;
